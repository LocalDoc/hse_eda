...
Рассмотрим что произойдет при cтимулирующей и сдерживающей фискальной политики ($"FP"(arrow.t, arrow.b)$). 
...
#let formal_1 = $
  & SS  =  G  arrow.t \ 
  & EE_("AE") stretch(==>)^(G arrow.t)   "AE"_0 arrow.t ==>
   "AE"_1_"pl" (R_1) < "AE"_2_"pl" (R_1) 
  stretch(==>)^(Y= Y_1) "AE" > Y ==> Y arrow.t 
  stretch(==>)^(Y = Y_2) "AE" = Y \ 
  & EE_(II SS -LL  MM) stretch(==>)^(R = R_1) Y arrow.t , space "IS"_2 > "IS"_1  stretch(==>)^(R=R_2) Y arrow.b \ 
...
*Multiplier effect. (Эффект мультипликатора илм изменение Y в KK).*
...
$
  triangle Y_("KK")= Y_2 - Y_1 = (1- "mpc")/(1-alpha) dot triangle G 
$

*Изменения равновесия в модели IS-LM.*

$
  triangle Y  =  Y_3 -  Y_1 = ((1-"mpc") dot m^d'_R)/triangle dot triangle G  
$
...
#let formal_3  = $
  & SS  = "MP"(arrow.t) stretch(==>)^(P=P_1) M/P arrow.t ==> R arrow.b stretch(==>)^("IS-LM") cases(Y_2 = Y_1 , "LM"_1 > "LM"_2)    \
  & EE_(II SS -LL  MM)  := cases(Y_2 = Y_1, "LM"_1 > "LM"_2) ==> R arrow.t stretch(==>)^(R= R_3) Y_3 > Y_2  = Y_1  \
  & EE_("AE")  := Y_3 > Y_1 = Y arrow.t stretch(==>)(triangle I) "AE"_"pl" arrow.t ==> "AE"_"pl"_1 < "AE"_"pl"_2  \
  & EE_(MM) : = R_2 > R_3 > R_1 stretch(==>)^(R = R_3) m^d arrow.t ==> m^d_2 > m^d_1  \
  
  & Re = cases(MM:= m^d_2 > m^d_1, "AE" := "AE"_"pl"_1 < "AE"_"pl"_2,  II SS -LL  MM :=  Y_3 > Y_2  = Y_1)
$
