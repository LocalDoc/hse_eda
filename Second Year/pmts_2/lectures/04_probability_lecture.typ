...
Иногда говорят, что создается статистическая линейная связь. Представим $z_2 = rho z_1 + underbrace(u,"шум")$, где $u "и" z_1$ независимы, и $u ~ N(dots, dots)$.
...
Если мы зафиксируем $z_2 | z_1 = x$, то $x_2$ останется с. в. , при этом можно утверждать что второе останется $~ N(rho x, 1 - rho^2)$. 
...
$
  xi_2^*=(xi_2- mu_2)/sigma_2 => xi_2 = sigma_2 dot xi_2^* + mu_2 , quad xi_1 = sigma_1 dot xi^*_1 + mu_1 
  \ \ 
