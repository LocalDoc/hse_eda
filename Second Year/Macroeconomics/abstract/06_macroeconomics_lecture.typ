...
#set align(center)
#figure(
  image("/Second Year/assets/image-24.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-14.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-16.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-17.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-18.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-25.png", width: 70%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-26.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-20.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-21.png", width: 60%),
...
#set align(center)
#figure(
  image("/Second Year/assets/image-23.png", width: 60%),
...
$
"но так как"-> "m"^d(R) "отрицательно зависит от ставки процента"  => arrow.t "величина спроса на деньги"
$
...
Другими словами:
Допустим что ставка процента на выросла до $"R"_2 > "R"_1$ на рынке ценных бумаг, тогда денежный рынок реагирует за ним, и получаем неравновесие на денежном рынке (дефицит спроса), и как результат, избыток спроса на рынке ценных бумаг (мы пришли в точку (3)). Далее, на рынке ценных бумаг, избыток спроса провоцирует падение ставки процента R пока она не вернеться на свое равновесное состояние $"R"_1$. Падение ставки процента приведет к падению спроса на ценные бумаги и роста предложения ценных бумаг, возвращая нас в состояние равновесия в точке (1). Далее, денежный рынок вновь среагирует на рынок ценных бумаг, и спрос на деньги начнет расти с упадком ставки процента, возвращая денежнный рынок обратно в равновесие.
